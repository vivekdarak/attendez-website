...
export function TypewriterServiceText() {
  ...
  return (
    <span
      aria-hidden="true"
      className="inline-block min-w-[min(19ch,100%)] whitespace-nowrap pb-1 leading-[1.18] bg-[image:var(--gradient-primary)] bg-clip-text text-transparent sm:leading-[1.14]"
    >
